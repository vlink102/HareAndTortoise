...
class RangeSliderUI extends BasicSliderUI {
    private Color rangeColor = UIManager.getColor("Slider.shadow");
    ...
    private void paintLowerThumb(Graphics g) {
        ...
        g2d.setColor(UIManager.getColor("Slider.focus").darker());
        g2d.fill(thumbShape);
        g2d.setColor(UIManager.getColor("Slider.focus"));
        g2d.draw(thumbShape);
